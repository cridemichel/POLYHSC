...
Over the last decade, the experimental realisation of nanoparticles has flourished unprecedentedly,  and nanoparticles of a whole variety of sizes, shapes, morphologies and functionalisations have been produced and characterised; phase diagrams have been investigated and novel intriguing phases - linked to the nature of the nanoparticles, and their eventual response to external stimuli - have arisen [CITAZIONI]. 

Surface chemistry is a fundamental aspect for the design and preparation of smart nanomaterials: the synthesis of solid colloidal nanoparticles (or nanocrystals) is a particularly intense research area with rapid improvements over both the  quality of the produced materials, and the knowledge of structure-property relationships.
The optimisation of the synthetic processes requires control both over the kinetic pathway (nucleation and growth of particles) as well as over the equilibrium thermodynamic properties, that provide the driving force for the precipitation of the solid, or for the stabilisation of a specific crystalline surface. 

A miscontrol over the synthesis process, might lead to unwanted aggregation events,  or to an eventual instability of the resulting nanoparticles. 
%It is often understood that nanoparticles can aggregate or that they are inherently unstable.
This is certainly an undesirable effect, as it affects the size distribution of the final nanoparticles, risking to render the synthesised material unusable for  any specific application purpose. In fact, both in optoelectronic applications, that require controlled self-assembly of the nanoparticles, as well as in biomedical ones, the control of the average size of the nanoparticles, as well as their monodispersion is a fundamental and critical factor for a reliable use of a specific nanomaterial. 
Even in the most controlled synthesis process, experimental nanoparticles are always characterised by a given polydispersity. For this reason, unveiling a path that would on the one hand allow for a control over the equilibrium properties of solutions of nanoparticles, and on the other, understand the effects of eventual miscontrol over the synthesis processes over the final properties of the nanocomposites, is a fundamental step for the usage of a specific nanomaterial.

Gold nanorods are very successful in the medical field due to their peculiar chemical-physical characteristics: i) high biocompatibility of gold ii) simple and versatile synthesis iii) longitudinal plasmon resonance band (LPR) which can be modulated in the 800-1200 nm zone , the so-called Near Infrared Window (NIR). This last aspect is of great medical interest because in that spectral range the high transmittance of the water (low absorption) allows the use of suitable lasers without interfering or burning healthy tissues and organs.
For this reason, gold nanorods represent an innovative contrast agent and at the same time can be a therapeutic tool, exploiting the localized increase in temperature under laser irradiation for the selective destruction of cancer cells.

Inspired by such a novelly synthesised rod shaped nanomaterial, this work presents a comprehensive experimental and theoretical approach, aimed at developing a simple theoretical tool to assess the quantitative effect of the experimental polydispersity over the equilibrium properties of solutions of the experimental nanoparticles. The in depth comprehension of the effect played by polydispersity on finite concentrations of nanoparticles in solution,  will also guide towards a more precise design for the synthesis of the nanomaterial, as it will evict which are the main parameters that require complete control if a control over solution properties is foreseen. 

Starting from a characterisation of the  experimental nanoparticles, we focus on the low density phase diagram of hard spherocylindrical colloids,  with particular attention on the effect of nanoparticles polydispersity on the compressibility of the system. All considered colloids will be defined by means of their elongation  $L$ and their diameter $D$, and every $(L,D)$ combination uniquely defines an aspect ratio $A=L/D$. We will  investigate $A \in [1,5]$ for packing fractions $\phi$ below the isotropic nematic transition [citazioni].
...
Starting from the monodisperse low density phase diagram,  we develop a set of  theoretical and computational tools to assess how the polidispersity in the aspect ratio of the nanoparticles affects the equilibrium properties of the solutions. 
 ...
 As in the case of spherical nanoparticles [citazioni di sfere], we find that polydispersity enhances packing  in dilute regimes even in the case of anisotropic colloidal fluids. 
 
To reach a complete understanding over the effect of polydispersity on the local and global properties of the solutions, we compare monodisperse systems with their polydisperse counterparts for a set of $A$. 
...
The paper is structured as follows: in the fist part, we present the reference experimental system, we then introduce a theoretical and computational modelling for the system, used to  estimate first the monodisperse low packing fraction phase diagram for hard spherocylinders with  $A=L/D \in [1,5]$, and then to generalise the result to the cases in which polydispersity is introduced on  $L$ and on   $D$, while fixing the average $A$.  We then show that even if no nematic order is present for the low packing fraction analysed, the systems present the emergence of a local alignment that appears to be more pronounced for the most elongated systems. 
We derive a simple theoretical tool, that we use to compare  the theoretical predictions to the computational estimates and demonstrate that we have a solid theory that, once known the polydispersity distributions for $D$ and $L$,  can be used to  quantitatively predict the deviations from the monodisperse EOS. 
...
The equation of state has been obtained for 
...
As introduced in the experimental motivation of the analysis, nanoparticles are affected by a strong polydispersity. This quantity will be extensively investigated in the coming sections. 

Let us introduce the Polydispersity Index used in this work as $PI_X = \Delta X / \overline{X}$, where $X$ is the analysed polydisperse quantity, and  $\Delta X = PI_X \; \overline{X}$ is the range of a  truncated Gaussian centered in $\overline{X}$ and with standard deviation $\sigma_X = {\Delta X}/{ 1.177}$. 


The spherocylindrical nanoparticles that are topic of investigation, can be characterised by different kinds of polydispersity: their diameter $D$ can be polydisperse, while their elongation remains unaffected, the opposite situation can take place, with $L$ being polydisperse and $D$ monodisperse, or the two quantities can be both affected by polydispersity. All those cases introduce a polydispersity over the aspect ratio; nevertheless the choice of the probability distribution defining polydispersity might lead to different equilibrium properties of solutions of polydisperse nanoparticles. To unveil the effect of polydispersity over the equilibrium properties, we  set the starting point of our investigation by computing the monodisperse equation of state for nanoparticles with  $A \in [1,5]$ and low packing fractions $\phi < \phi_{N}$, where $\phi_N$ is the isotropic-nematic transition packing fraction.  As a matter of fact $\phi_N=\phi_N(A)$, and the lowest value for $\phi_N$ in the analysed systems is $\phi_N(A)=0.4$. We thus perform all of our investigations for $\phi \in (0,0.3]$ (that correspond to reduced pressures $P^* = \beta P v_0 \in [0.01; 1]$) . As the starting configuration for the simulations is an orthorombic ordered crystalline phase, simulations are performed for $N = 1296$ particles. 

Once determined the monodisperse phase diagram, we perform an in depth investigation over all of the aforementioned combinations for the $L,D$ and $A$ polydispersities. All of the considered combinations for the analysed polydispersities, are shown in figure \ref{fig:Polydispersity_histograms}. 
...
\begin{align}
    P^* &= \beta P \, \overline{v_0} = - \beta \, \overline{v_0} \, \frac{\partial F}{\partial V} \rvert _{N, T} =  P^*_{id} - \beta \, \overline{v_0} \frac{\partial F_{excl}}{\partial V} \rvert _{N, T} \\ &= \phi - N \beta \, \overline{v_0} \frac{\overline{v_{excl}}}{8 \, \overline{v_0}} \frac{\partial}{\partial V} \left( \phi \frac{4 - 3 \phi}{(1 - \phi)^2} \right) \nonumber = \phi + \frac{\overline{v_{excl}}}{4 \, \overline{v_0}} \phi^2 \frac{2 - \phi}{(1 - \phi)^3} \label{ParsonLee}
\end{align}
